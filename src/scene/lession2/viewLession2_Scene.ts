...
export default class ViewLession2_Scene {
	//#region 宣告變數
	private scene: any;
	private camera: any;
	...
	private initScene() {
        ...
        this.grass = loader.load([grassTexture, grassTexture, grassTexture, grassTexture, stoneTexture, grassTexture]);
        this.grass.encoding = THREE.sRGBEncoding;
        this.grass.mapping = THREE.CubeReflectionMapping;

		this.scene = new THREE.Scene();
        this.scene.background = this.grass;
        /////////////////////////////////////////////////////////////
	...
	private initMesh() {
        ...
        // 關鍵行 /////////////////////////////////////////////////////////////
		const materialPhong = new THREE.MeshBasicMaterial({ side: THREE.DoubleSide, envMap: this.grass });
	...
	private render() {
        ...
        // 關鍵行 /////////////////////////////////////////////////////////////
        this.grass.mapping = this.refraction ? THREE.CubeRefractionMapping : THREE.CubeReflectionMapping;
